...
export async function generateMetadata(props: {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}/blog/post/ru/${slug}`,
    ...
    keywords: [
      "ИИ-агенты",
      "MVP-решения",
      "Автоматизация ИИ-агентов",
      "Разработка ИИ-агентов",
      "Обучение ИИ-агентов",
      "Внедрение ИИ-агентов",
      "Оптимизация ИИ-агентов",
      "Мониторинг ИИ-агентов",
      "Устранение неполадок ИИ-агентов",
      "Обслуживание ИИ-агентов",
    ],
...
export async function generateStaticParams(): Promise<{ slug: string }[]> {
  // Get MDX files from the Russian directory
  const postsDirectory = path.join(process.cwd(), "app/blog/_posts/ru");
  ...
  return (
    <>
      <StructuredData
        ...
        description={post.metadata.description}
        mainEntityOfPage={`https://www.explainx.ai/blog/post/ru/${slug}`}
        publisher={{
