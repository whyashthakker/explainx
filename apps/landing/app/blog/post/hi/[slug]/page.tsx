...
export async function generateMetadata(props: {
  ...
  return {
    ...
    alternates: {
      canonical: `${baseUrl}/blog/post/hi/${slug}`,
...
export async function generateStaticParams(): Promise<{ slug: string }[]> {
  // Get MDX files from the Hindi directory
  const postsDirectory = path.join(process.cwd(), "app/blog/_posts/hi");
...
export default async function Page(props: { params: Params }) {
  ...
  if (post.type === "database" && "content" in post) {
    ...
    // For Hindi, reading speed might be different, but using similar estimate for consistency
