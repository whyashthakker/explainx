...
*/
-- DropForeignKey
ALTER TABLE "CollaborationInvite" DROP CONSTRAINT "CollaborationInvite_brandId_fkey";

-- DropForeignKey
ALTER TABLE "CollaborationInvite" DROP CONSTRAINT "CollaborationInvite_influencerId_fkey";
